...
BlaineGroup:
	...
	tr_mon 69, MAGMORTAR @ BLACK_BELT
	...
	tr_mon 70, RAPIDASH @ SITRUS_BERRY
		tr_evs 252 Atk, 228 Spe
...
BlueGroup:
	...
	def_trainer 1, "Blue"
	tr_mon 70, EXEGGUTOR @ ROOM_SERVICE
		tr_moves PSYCHIC_M, LEECH_SEED, TRICK_ROOM, GIGA_DRAIN
	tr_mon 74, PIDGEOT @ BRIGHTPOWDER
		tr_extra NO_GUARD
		tr_moves ROOST, EXTREMESPEED, HURRICANE, FOCUS_BLAST
	tr_mon 72, MACHAMP @ CHOICE_BAND
		tr_extra NO_GUARD
	...
	tr_mon 75, CHARIZARD @ LIFE_ORB, MALE
		tr_extra TOUGH_CLAWS, ATK_UP_SATK_DOWN
		tr_moves FLARE_BLITZ, DRAGON_DANCE, EARTHQUAKE, OUTRAGE
	end_trainer

	def_trainer 2, "Blue"
	tr_mon 74, UMBREON @ BRIGHTPOWDER
		tr_moves CONFUSE_RAY, TOXIC, FEINT_ATTACK, PROTECT
	tr_mon 73, MACHAMP @ CHOICE_BAND
		tr_extra NO_GUARD
	...
	tr_mon 78, PIDGEOT @ BRIGHTPOWDER
		tr_extra NO_GUARD
		tr_moves ROOST, EXTREMESPEED, HURRICANE, FOCUS_BLAST
...
RedGroup:
	...
	def_trainer 1, "Red"
	tr_mon 99, RAICHU @ LIFE_ORB, MALE
		tr_extra STATIC, SPE_UP_SDEF_DOWN
		tr_moves THUNDER, SURF, IRON_TAIL, WILD_CHARGE
	tr_mon 96, ESPEON @ TWISTEDSPOON, FEMALE
		tr_extra MAGIC_BOUNCE, SATK_UP_ATK_DOWN
		tr_moves PSYCHIC_M, DAZZLINGLEAM, REFLECT, SHADOW_BALL
	tr_mon 95, SNORLAX @ LEFTOVERS, MALE
		tr_extra IMMUNITY, ATK_UP_SATK_DOWN
		tr_moves CURSE, REST, EARTHQUAKE, RETURN
	tr_mon 95, GENGAR @ SPELL_TAG, MALE
		tr_extra SHADOW_TAG, SATK_UP_ATK_DOWN
		tr_moves THUNDERBOLT, NASTY_PLOT, SHADOW_BALL, DAZZLINGLEAM
	tr_mon 96, ARCANINE @ CHARCOAL, MALE
		tr_extra INTIMIDATE, ATK_UP_SATK_DOWN
		tr_moves CLOSE_COMBAT, EARTHQUAKE, FLARE_BLITZ, WILD_CHARGE
	tr_mon 100, VENUSAUR @ WIDE_LENS, MALE
		tr_extra THICK_FAT, SATK_UP_ATK_DOWN
		tr_moves EARTH_POWER, GIGA_DRAIN, SLUDGE_BOMB, SLEEP_POWDER
	end_trainer
...
LeafGroup:
	...
	def_trainer 1, "Green"
	tr_mon 96, FORRETRESS @ LEFTOVERS, FEMALE
		tr_extra STURDY
		tr_moves GYRO_BALL, TOXIC_SPIKES, VOLT_SWITCH, SPIKES
	tr_mon 100, BLASTOISE @ LIFE_ORB, MALE
		tr_extra MEGA_LAUNCHER, SATK_UP_ATK_DOWN
		tr_moves HYDRO_PUMP, ICE_BEAM, FLASH_CANNON, SHELL_SMASH
	tr_mon 98, MOLTRES @ CHARCOAL, FEMALE
		tr_extra FLAME_BODY, SATK_UP_ATK_DOWN
		tr_moves FIRE_BLAST, HURRICANE, HP_GRASS, ROOST
	tr_mon 95, CLEFABLE @ ROCKY_HELMET, FEMALE
		tr_extra MAGIC_GUARD, SATK_UP_ATK_DOWN
		tr_moves MOONBLAST, CALM_MIND, FRESH_SNACK, FIRE_BLAST
	tr_mon 96, NIDOQUEEN @ BLACK_SLUDGE
		tr_extra SHEER_FORCE, ATK_UP_SATK_DOWN
		tr_moves EARTHQUAKE, HEALINGLIGHT, POISON_JAB, ICE_PUNCH
...
Rival2Group:
	...
	tr_mon 72, WEAVILE @ KINGS_ROCK
		tr_extra TECHNICIAN
		tr_moves SWORDS_DANCE, ICE_SHARD, CUT, FEINT_ATTACK
	tr_mon 73, CROBAT @ POISON_BARB
		tr_moves POISON_JAB, CRUNCH, CONFUSE_RAY, TOXIC
	tr_mon 72, ELECTIVIRE @ MUSCLE_BAND
		tr_moves CLOSE_COMBAT, WILD_CHARGE, FIRE_PUNCH, EARTHQUAKE
	tr_mon 72, MISMAGIUS @ CHARCOAL, FEMALE
		tr_moves SHADOW_BALL, FLAMETHROWER, DAZZLINGLEAM, POWER_GEM
	tr_mon 72, URSALUNA @ FLAME_ORB
		tr_extra GUTS
		tr_moves EARTHQUAKE, CLOSE_COMBAT, PLAY_ROUGH, GIGA_IMPACT
	tr_mon 75, MEGANIUM @ LEFTOVERS
	...
	tr_mon 72, URSALUNA @ FLAME_ORB
		tr_extra GUTS
		tr_moves EARTHQUAKE, CLOSE_COMBAT, PLAY_ROUGH, GIGA_IMPACT
	tr_mon 75, TYPHLOSION @ LEFTOVERS
	...
	tr_mon 72, URSALUNA @ FLAME_ORB
		tr_extra GUTS
		tr_moves EARTHQUAKE, CLOSE_COMBAT, PLAY_ROUGH, GIGA_IMPACT
	tr_mon 75, FERALIGATR @ LIFE_ORB
		tr_extra SHEER_FORCE
		tr_moves WATERFALL, CRUNCH, EARTHQUAKE, OUTRAGE
	end_trainer
